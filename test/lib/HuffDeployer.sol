...
contract HuffConfig {
    ...
    function deployWithArgs(string memory file, bytes memory _args) public payable returns (address) {
        binary_check();
        ...
        // FIXME: It causes problems when using delegatecall
        ...
        bytes memory concatenated = bytes.concat(bytecode, _args);
